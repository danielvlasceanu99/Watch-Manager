...
export class UserFavoriteComponent implements OnInit {
    ...
    getMovies() {
        if (this.user?.likedMovies !== undefined) {
            this.isLoading = true;
            this.movieService.getbyList(this.user?.likedMovies).subscribe((res) => {
                this.movies = res;
    ...
    getTvShows() {
        if (this.user?.likedTv !== undefined) {
            this.isLoading = true;
            this.tvService.getbyList(this.user?.likedTv).subscribe((res) => {
                this.tvShows = res;
